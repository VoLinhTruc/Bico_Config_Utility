...
#define SETTING_CONNECT_PACKET "SETTING_CONNECT_PACKET"
#define SETTING_SUBSCRIBE_PACKET "SETTING_SUBSCRIBE_PACKET"
#define SETTING_PUBLISH_PACKET "SETTING_PUBLISH_PACKET"
...
#define CONNECT_PACKET_PROPERTIES "CONNECT_PACKET_PROPERTIES"
#define SUBSCRIBE_PACKET_PROPERTIES "SUBSCRIBE_PACKET_PROPERTIES"
#define PUBLISH_PACKET_PROPERTIES "PUBLISH_PACKET_PROPERTIES"
...
#define NUM_OF_SUBSCRIBE_PACKET 5
...
private slots:
    ...
    void on_configuration_data_clear_all_pushButton_clicked();
    void on_data_from_com_port_clear_all_pushButton_clicked();
    void on_general_setting_without_authentication_checkBox_stateChanged(int arg1);
};
