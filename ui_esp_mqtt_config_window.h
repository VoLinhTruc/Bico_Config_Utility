...
public:
    ...
    void setupUi(QMainWindow *ESP_MQTT_Config_Window)
    {
        ...
        data_from_com_port_plainTextEdit->setGeometry(QRect(20, 120, 371, 481));
        ...
        data_from_com_port_clear_all_pushButton->setGeometry(QRect(310, 90, 71, 23));
        ...
        append_content_checkBox->setGeometry(QRect(470, 110, 101, 17));
        ...
        configuration_data_plainTextEdit->setGeometry(QRect(470, 140, 291, 421));
        ...
        configuration_data_clear_all_pushButton->setGeometry(QRect(690, 110, 71, 23));
